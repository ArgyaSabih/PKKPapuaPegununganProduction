...
export function HeaderSlug({ title, date, author, ...props }) {
  return (
...
export function ContentSlug({ body, ...props }) {
  return (
...
export function GallerySlug({ images, ...props }) {
  return (
...
export function ArticleListSlug({ ...props }) {
  return (
    <div className="mt-[3vw] flex w-full flex-col items-center justify-center gap-y-[3vw] lg:mt-[1.5vw] lg:gap-y-[1.5vw]">
      <div className="flex w-full flex-row items-center justify-center gap-x-[28px]">
